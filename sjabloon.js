...
tekstInvoer.addEventListener('change', () => {
    const nieuweTekst = tekstInvoer.value;
    draggable.textContent = nieuweTekst;
...
// const oefening2L3 = documument.getElementById("oef2")
...
Alertbtn.addEventListener('click',function (){
    ...
    // console.log(blur)
    // if (filter2L3.includes(blur) && filter2L3.includes(contrast)){
